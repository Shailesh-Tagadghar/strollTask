...
class ColorConstant {
  static const bonfireTextColor = Color(0xFFCCC8FF);
  static const dropdownColor = Color(0xFFCBC9FF);
  static const whiteColor = Color(0xFFFFFFFF);
  static const userNameColor = Color(0xFFF5F5F5);
  static const optionColor = Color(0xFFC4C4C4);
  static const optionTextColor = Color(0xFFE5E5E5);
